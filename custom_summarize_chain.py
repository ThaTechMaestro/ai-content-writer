...
class DocumentSummary(BaseModel):
    ...
    metadata: Optional[Dict[str, str]] = {}  # This comes natively from the LangChain document loader
    
async def create_summary_from_text(
    document: Document,
    parser: PydanticOutputParser,
    llm: ChatOpenAI,
    text_splitter: RecursiveCharacterTextSplitter) -> Union[DocumentSummary, None]:
...
async def create_all_summaries(
    ...
    parser: PydanticOutputParser,
    llm: ChatOpenAI,
    text_splitter: RecursiveCharacterTextSplitter) -> List[DocumentSummary]:  
